  ...
  return <>
    <>
      <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', flexWrap: 'wrap'}}>
        <div style={{width: '100vw',display: 'flex', flexDirection:'column', textAlign: 'center', alignContent: 'center', alignItems: 'center', paddingLeft: '25%', paddingRight: '25%', gap:'10px', paddingTop:'100px', paddingBottom: '100px'}}>
