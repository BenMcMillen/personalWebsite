...
const RobotImp = function({ }) {
  ...
  return <>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', flexWrap: 'wrap', padding: '150px 25%', }}>
      ...
      <a style={{textAlign: 'center'}} href="" target="_blank" rel="noopener noreferrer">
      ...
      <div style={{display: 'flex', gap: '20px', marginTop: '50px', flexWrap: 'wrap'}}>
        ...
        <div style={{flex: '1'}}>
          ...
          <div style={{color:'#555'}}>The software itself worked successfully for the provided simulator and physical robot. This was completed to a high level as it allowed me to tutor the course in the next trimester it was run</div>
        </div>
